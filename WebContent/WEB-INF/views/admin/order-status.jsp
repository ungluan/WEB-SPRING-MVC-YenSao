		...
		<%@ include file="/WEB-INF/views/include/admin-slider-bar.jsp" %>
			...
			<div class="container-fluid">
				...
				<c:if test="${btnStatus=='btnAdd'}">
					<form:form action="orderstatus/index" method="post"
						...
						<div class="form-outline mb-3">
							<label class="form-label" for="form3Example4">Trạng thái đơn hàng</label>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							<h3 class="box-title">Danh sách trạng thái đơn hàng</h3>
							<!-- ==== -->
							<form class="d-inline-flex">
								<input name="searchInput" id="searchInput"
									class="form-control me-3" type="search" placeholder="Vui lòng nội dung"
									aria-label="Search">
